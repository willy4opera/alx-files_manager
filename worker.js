...
userQueue.process(async (job, done) => {
  ...
  try {
    ...
    const mailContent = [
      ...
      'Welcome to <a href="https://github.com/willy4opera/alx-files_manager">',
      "ALX-Files_Manager</a>, ",
      "A simple file management API built using Node.js by ",
      '<a href="https://github.com/willy4opera">Odionye Obiajulu Williams</a>. ',
      "Made with to meets your needs.",
      "</div>",
    ].join("");
